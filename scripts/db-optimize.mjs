...
const indexStatements = [
  ...
  "alter table domains add column if not exists linked_bank_account_id uuid references bank_accounts(id) on delete set null",
  "create index if not exists idx_domains_dashboard_position on domains (dashboard_position)",
  "create index if not exists idx_domains_linked_bank_account on domains (linked_bank_account_id) where linked_bank_account_id is not null",
  ...
  "create index if not exists idx_exchange_requests_updated_at on exchange_requests (updated_at desc)",
