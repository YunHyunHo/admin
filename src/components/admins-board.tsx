        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/72 px-4">
          <div className="w-full max-w-[490px] rounded-lg bg-white p-6 text-slate-950 shadow-2xl">
            ...
            <div className="mt-9 space-y-6">
              ...
              <div className="flex h-14 w-full items-center rounded border border-slate-300 px-5 text-sm font-medium text-slate-700">
                업체 계정
              </div>
              <input
                value={nickname}
              ...
              <p className="text-sm text-slate-500">
                계정을 만든 뒤 테이블의 업체설정에서 연결할 업체를 선택하면, 해당 업체 기준으로 충전신청과 관리 화면을 분리해서 볼 수 있습니다.
              </p>
            </div>
